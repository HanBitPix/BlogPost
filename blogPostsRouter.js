...
// Get the value of key BlotPosts : createBlogPostsModel()
const { BlogPosts } = require('./models');

// Creates the contents for the blog
function loremIpsum() {
...
// creates some blogs so we have something to work with
BlogPosts.create(
  'All about me Blog.', loremIpsum(), 'Jacob Han');
BlogPosts.create(
  'If chickens can fly...', loremIpsum(), 'Chicken Lover');
BlogPosts.create(
  'If humans have power, what would you have?', loremIpsum(), 'Superhero Lover');
